...
| =sage-shell-view-enable-inline-output=  | Enable inline display of LaTeX outputs while SageMath process is running  |
| =sage-shell-view-disable-inline-output= | Disable inline display of LaTeX outputs while SageMath process is running |
| =sage-shell-view-enable-inline-plots=   | Enable inline display of  plots while SageMath process is running         |
| =sage-shell-view-disable-inline-plots=  | Disable inline display of plots while SageMath process is running         |
